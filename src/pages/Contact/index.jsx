        ...
        return (
            ...
            <div class="container" >
                <div className="row contact">
                    ...
                    <div className="col-lg-6">
                    <form style={{boxShadow: '24px 50px 60px rgba(0,0,0,.3)'}} className={styles.container} noValidate >
                    <TextField
                        id="standard-search"
                        label="Name"
                        type="search"
                    ...
                    <TextField
                        ...
                        rowsMax="4"
                    />
                    <Button style={{margin: '20px'}} variant="contained" className={styles.button}>
                        Submit
                    </Button>
                    </form>
